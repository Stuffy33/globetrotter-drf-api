# GlobeTrotter
GlobeTrotter is a website for people that want to experiance capetown but are not intressted in the normal turist traps but instead want to do what locals recommend.
